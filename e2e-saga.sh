...
# container preflight, shared with ./e2e-saga-outage.sh: is the stack up at all, and is
# user-collections stopped as an @outage leftover (quietly healed) or because it CRASHED
# (loudly reported, then started anyway) — see e2e/preflight-stack.sh
